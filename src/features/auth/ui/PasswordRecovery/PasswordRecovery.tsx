...
const PASSWORD_RECOVERY_FIELDS: (keyof PasswordRecoveryFormValues)[] = [
  'email',
];
    ...
    return (
      <View style={styles.container}>
          ...
          <View style={styles.errorSlot}>
            {passwordRecoveryErrors.email ? (
              <Text style={styles.errorText}>
                {passwordRecoveryErrors.email.message}
              </Text>
            ) : null}
          </View>
        </View>
        ...
        {passwordRecoveryErrors.root ? (
          <View style={styles.errorSlot}>
            <Text style={styles.errorText}>
              {passwordRecoveryErrors.root.message}
            </Text>
          </View>
        ) : null}
        ...
        {newPasswordErrors.root ? (
          <View style={styles.errorSlot}>
            <Text style={styles.errorText}>
              {newPasswordErrors.root.message}
            </Text>
          </View>
        ) : null}
